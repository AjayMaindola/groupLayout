...
export default function Header() {
  return (
    <>
      <nav className="bg-white  px-4 lg:px-6 py-2.5 flex justify-between ">
              <h1 className="self-center text-xl ms-5 text-slate-500 font-semibold whitespace-nowrap ">
                Dashboard
              </h1>
              <div className="flex items-center lg:order-2 absolute right-5 top-3 ">
